...
const std::function<void(merutilm::rff::SettingsMenu &, merutilm::rff::RenderScene &)> merutilm::rff::CallbackVideo::DATA_SETTINGS = [
...
const std::function<void(merutilm::rff::SettingsMenu &, merutilm::rff::RenderScene &)> merutilm::rff::CallbackVideo::ANIMATION_SETTINGS = [
        ](SettingsMenu &settingsMenu, RenderScene &scene) {
...
const std::function<void(merutilm::rff::SettingsMenu &, merutilm::rff::RenderScene &)> merutilm::rff::CallbackVideo::EXPORT_SETTINGS = [
        ](SettingsMenu &settingsMenu, RenderScene &scene) {
...
const std::function<void(merutilm::rff::SettingsMenu &, merutilm::rff::RenderScene &)>merutilm::rff:: CallbackVideo::GENERATE_VID_KEYFRAME = [
...
const std::function<void(merutilm::rff::SettingsMenu &, merutilm::rff::RenderScene &)> merutilm::rff::CallbackVideo::EXPORT_ZOOM_VID = [
        ](SettingsMenu &, RenderScene &scene) {
