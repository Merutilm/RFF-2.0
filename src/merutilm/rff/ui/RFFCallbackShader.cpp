...
const std::function<void(RFFSettingsMenu &, RFFRenderScene &)> RFFCallbackShader::PALETTE = [
    ...
    window->registerTextInput<float>("Iteration Interval", &settings.iterationInterval, RFF::Unparser::FLOAT,
                                     RFF::Parser::FLOAT, RFF::ValidCondition::POSITIVE_FLOAT, [&scene] {
                                         scene.requestColor();
                                     }, "Set Iteration Interval", "Required iterations for the palette to cycle once");
    window->registerTextInput<float>("Offset Ratio", &settings.offsetRatio, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::FLOAT_ZERO_TO_ONE, [&scene] {
                                         scene.requestColor();
                                     }, "Set Offset Ratio",
                                     "Start offset ratio of cycling palette. 0.0 ~ 1.0 value required.");
    window->registerTextInput<float>("Animation Speed", &settings.animationSpeed, RFF::Unparser::FLOAT,
                                     RFF::Parser::FLOAT, RFF::ValidCondition::ALL_FLOAT, [&scene] {
                                         scene.requestColor();
                                     }, "Set Animation Speed",
...
const std::function<void(RFFSettingsMenu &, RFFRenderScene &)> RFFCallbackShader::STRIPE = [
    ...
    window->registerTextInput<float>("Interval 1", &settings.firstInterval, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::POSITIVE_FLOAT, [&scene] {
                                         scene.requestColor();
                                     }, "Set interval 1", "Sets the first Stripe Interval");
    window->registerTextInput<float>("Interval 2", &settings.secondInterval, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::POSITIVE_FLOAT, [&scene] {
                                         scene.requestColor();
                                     }, "Set interval 2", "Sets the second Stripe Interval");
    window->registerTextInput<float>("Opacity", &settings.opacity, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::FLOAT_ZERO_TO_ONE, [&scene] {
                                         scene.requestColor();
                                     }, "Set opacity", "Sets the opacity of stripes.");
    window->registerTextInput<float>("Offset", &settings.offset, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::ALL_FLOAT, [&scene] {
                                         scene.requestColor();
...
const std::function<void(RFFSettingsMenu &, RFFRenderScene &)> RFFCallbackShader::SLOPE = [
    ...
    window->registerTextInput<float>("Depth", &settings.depth, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::ALL_FLOAT, [&scene] {
                                         scene.requestColor();
                                     }, "Set Depth", "Sets the depth of slope.");

    window->registerTextInput<float>("Reflection Ratio", &settings.reflectionRatio, RFF::Unparser::FLOAT,
                                     RFF::Parser::FLOAT,
                                     RFF::ValidCondition::FLOAT_ZERO_TO_ONE, [&scene] {
                                         scene.requestColor();
    ...
    window->registerTextInput<float>("Zenith", &settings.zenith, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::FLOAT_DEGREE, [&scene] {
                                         scene.requestColor();
                                     }, "Set Zenith", "Sets the zenith of the slope. 0 ~ 360 value is required.");

    window->registerTextInput<float>("Azimuth", &settings.azimuth, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::FLOAT_DEGREE, [&scene] {
                                         scene.requestColor();
...
const std::function<void(RFFSettingsMenu &, RFFRenderScene &)> RFFCallbackShader::COLOR = [
    ...
    window->registerTextInput<float>("Gamma", &settings.gamma, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::ALL_FLOAT, [&scene] {
                                         scene.requestColor();
                                     }, "Set Gamma", "Sets the gamma.");
    window->registerTextInput<float>("Exposure", &settings.exposure, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::ALL_FLOAT, [&scene] {
                                         scene.requestColor();
                                     }, "Set Exposure", "Sets the exposure.");
    window->registerTextInput<float>("Hue", &settings.hue, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::ALL_FLOAT, [&scene] {
                                         scene.requestColor();
                                     }, "Set hue", "Sets the hue.");
    window->registerTextInput<float>("Saturation", &settings.saturation, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::ALL_FLOAT, [&scene] {
                                         scene.requestColor();
                                     }, "Set Saturation", "Sets the saturation.");
    window->registerTextInput<float>("Brightness", &settings.brightness, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::ALL_FLOAT, [&scene] {
                                         scene.requestColor();
                                     }, "Set Brightness", "Sets the brightness.");
    window->registerTextInput<float>("Contrast", &settings.gamma, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                     RFF::ValidCondition::ALL_FLOAT, [&scene] {
                                         scene.requestColor();
...
const std::function<void(RFFSettingsMenu &, RFFRenderScene &)> RFFCallbackShader::FOG = [
    ...
    window->registerTextInput<float>("Radius", &settings.radius, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                  RFF::ValidCondition::FLOAT_ZERO_TO_ONE, [&scene] {
                                      scene.requestColor();
...
const std::function<void(RFFSettingsMenu &, RFFRenderScene &)> RFFCallbackShader::BLOOM = [
    ...
    window->registerTextInput<float>("Threshold", &settings.threshold, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                  RFF::ValidCondition::FLOAT_ZERO_TO_ONE, [&scene] {
                                      scene.requestColor();
    ...
    window->registerTextInput<float>("Softness", &settings.softness, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                  RFF::ValidCondition::ALL_FLOAT, [&scene] {
                                      scene.requestColor();
                                  }, "Set Softness", "Sets the softness of the bloom.");
    window->registerTextInput<float>("Intensity", &settings.intensity, RFF::Unparser::FLOAT, RFF::Parser::FLOAT,
                                  RFF::ValidCondition::ALL_FLOAT, [&scene] {
                                      scene.requestColor();
