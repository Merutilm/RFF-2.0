...
LRESULT CALLBACK merutilm::rff::MainWindow::masterWindowProc(const HWND masterWindow, const UINT message, const WPARAM wParam,
                                                             const LPARAM lParam) {
...
LRESULT CALLBACK merutilm::rff::MainWindow::renderSceneProc(const HWND renderWindow, const UINT message, const WPARAM wParam,
                                                  const LPARAM lParam) {
...
merutilm::rff::MainWindow::MainWindow() : scene(RenderScene()) {
    initWindow();
}

void merutilm::rff::MainWindow::initMenu(const HMENU hMenubar) {
    settingsMenu = std::make_unique<SettingsMenu>(hMenubar);
}


void merutilm::rff::MainWindow::initWindow() {
    SetProcessDPIAware();
...
void merutilm::rff::MainWindow::setClientSize(const int width, const int height) const {
...
void merutilm::rff::MainWindow::adjustClient(const RECT &rect) const {
...
void merutilm::rff::MainWindow::refreshStatusBar() const {
    for (int i = 0; i < Constants::Status::LENGTH; ++i) {
        SendMessage(statusBar, SB_SETTEXT, i, (LPARAM) TEXT(statusMessages[i].data()));
    }
}

void merutilm::rff::MainWindow::createStatusBar() {
...
void merutilm::rff::MainWindow::createMasterWindow(const HMENU hMenubar) {
...
void merutilm::rff::MainWindow::createRenderScene() {
    ...
    GLLoader::createContext(hdc, &context);
}

void merutilm::rff::MainWindow::renderLoop() {
...
merutilm::rff::RenderScene &merutilm::rff::MainWindow::getRenderScene() {
    return scene;
}
