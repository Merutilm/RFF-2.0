...
namespace merutilm::rff2 {
    struct VideoRenderSceneRenderer final : public vkh::RendererAbstract {
        ...
        explicit VideoRenderSceneRenderer(vkh::EngineRef engine, const uint32_t windowContextIndex) :
            RendererAbstract(engine, windowContextIndex) {
            VideoRenderSceneRenderer::init();
        }

        ~VideoRenderSceneRenderer() override { VideoRenderSceneRenderer::destroy(); }
    ...
    private:
        void init() override {
            ...
            renderer2MapIterationStripe =
                    vkh::PipelineConfiguratorAbstract::createShaderProgram<CPC2MapIterationStripe>(
            ...
            rendererFog = vkh::PipelineConfiguratorAbstract::createShaderProgram<GPCFog>(
                    configurators, engine, wc.getAttachmentIndex(), RCC2Vid::CONTEXT_INDEX, RCC2Vid::SUBPASS_FOG_INDEX);
            ...
            rendererLinearInterpolation =
                    vkh::PipelineConfiguratorAbstract::createShaderProgram<GPCLinearInterpolation>(
