...
namespace merutilm::rff2 {
    struct RCCLinearInterpolation final : public vkh::RenderContextConfiguratorAbstract{
        ...
        void configureRenderContext(vkh::RenderPassManagerRef rpm) override {
            ...
            rpm.appendDependency({
                ...
                .dstSubpass = SUBPASS_LINEAR_INTERPOLATION_INDEX,
            ...
            rpm.appendDependency({
                .srcSubpass = SUBPASS_LINEAR_INTERPOLATION_INDEX,
