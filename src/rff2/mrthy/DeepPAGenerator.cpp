...
namespace merutilm::rff2 {
    ...
    void DeepPAGenerator::step() {
        ...
        dex_trigonometric::hypot_approx(&temps[0], &temps[6], temps[0], temps[1]);
        dex_trigonometric::hypot_approx(&temps[1], &temps[6], bnr, bni);
        dex::cpy(&bnr, temps[4]);
        dex::cpy(&bni, temps[5]);
        ...
        dex_trigonometric::hypot_approx(&temps[6], &temps[4], anr, ani);
