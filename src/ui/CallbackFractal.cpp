...
const std::function<void(merutilm::rff::SettingsMenu &, merutilm::rff::RenderScene &)> merutilm::rff::CallbackFractal::REFERENCE = [
...
const std::function<void(merutilm::rff::SettingsMenu &, merutilm::rff::RenderScene &)> merutilm::rff::CallbackFractal::ITERATIONS = [
        ](SettingsMenu &settingsMenu, RenderScene &scene) {
    auto &calc = scene.getSettings().calculationSettings;
...
const std::function<void(merutilm::rff::SettingsMenu &, merutilm::rff::RenderScene &)> merutilm::rff::CallbackFractal::MPA = [
        ](SettingsMenu &settingsMenu, RenderScene &scene) {
    ...
    auto window = std::make_unique<SettingsWindow>("MPA");
...
const std::function<bool*(merutilm::rff::RenderScene &)> merutilm::rff::CallbackFractal::AUTOMATIC_ITERATIONS = [
        ](RenderScene &scene) {
    return &scene.getSettings().calculationSettings.autoMaxIteration;
};

const std::function<bool*(merutilm::rff::RenderScene &)> merutilm::rff::CallbackFractal::ABSOLUTE_ITERATION_MODE = [
        ](RenderScene &scene) {
