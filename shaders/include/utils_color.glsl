...
#ifndef UTILS_COLOR_INCLUDE
#define UTILS_COLOR_INCLUDE
...
vec3 color_apply(vec3 c){
    ...
    return fix_color((c - 0.5) / (1 - color_settings.contrast) * (1 + color_settings.contrast) + 0.5);
}
